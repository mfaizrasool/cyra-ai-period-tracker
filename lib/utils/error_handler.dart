...
class ErrorHandler {
  ...
  void _handleAuthenticationError() {
    ...
    // Note: Direct navigation to LoginScreen instead of named route
  ...
  static AppException networkError(String message) {
    return AppException(message: message, type: ErrorType.network);
  }

  static AppException authenticationError(String message) {
    return AppException(message: message, type: ErrorType.authentication);
  }

  static AppException validationError(String message) {
    return AppException(message: message, type: ErrorType.validation);
  }

  static AppException serverError(String message) {
    return AppException(message: message, type: ErrorType.server);
  }

  static AppException permissionError(String message) {
    return AppException(message: message, type: ErrorType.permission);
  }

  static AppException fileError(String message) {
    return AppException(message: message, type: ErrorType.file);
  }
}
